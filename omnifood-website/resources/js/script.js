$(document).ready(function() {
    ...
    $('.js--nav-icon').click(function() {
        ...
        var  nav = $('.js--main-nav'); //my main nav
        var icon = $(".menu-icon"); // the class name i gave to ion icon 
 
        nav.slideToggle(300); //animation
 
        if(icon.attr("name") === "menu") { //if the attribute name of icon is == to menu
